        ...
        <nav class="navbar navbar-expand-lg navbar-light text-light bg-info">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{route('home')}}">
                    <img class="logo" src="{{asset('img/negocio.png')}}" />
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link active" aria-current="page" href="{{route('home')}}">Agregar negocio</a>
                        <a class="nav-link" href="{{route('ver_negocio')}}">Ver negocios</a>
                        <a class="nav-link" href="{{route('ver_producto')}}">Ver productos</a>
